        ...
        <div className="max-w-7xl mx-auto bg-black my-20">
            ...
            >
              ...
              />
                ...
                <input type="text" name="" id="" placeholder="Your Name" className="border hover:border-red-600 p-4 bg-gray-900"/>
                <input type="email" name="" id="" placeholder="Your Email" className="border hover:border-red-600 p-4 bg-gray-900" />
                <textarea name="" id="" cols="30" rows="6" placeholder="Write Your Message" className="border hover:border-red-600 bg-gray-900 p-4"></textarea>
                </div>
                <div className="my-10">
