  ...
  return (
    <div className="">
      ...
      <title>Kester | NEWS
        ...
        <BannerImg
        subHeading={'home | News'}
        heading={'blog'}
        ></BannerImg>
      <div className="max-w-7xl mx-auto">
      <div className="flex flex-col gap-4 lg:flex-row">
        <div className="w-full lg:w-[60%] ">
          <div className="mb-10 lg:mx-0 mx-4 ">
            <div className="card bg-base-100 shadow-xl  border">
              <figure>
                <img
                  src="	https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/06/banner-bg10.jpg"
                  alt="Shoes"
                />
              </figure>
              <div className="card-body">
                ...
                <h2 className="card-title font-extrabold text-4xl my-4">
          ...
          <div className="mb-10 lg:mx-0 mx-4">
            <div className="card bg-base-100 shadow-xl border">
              <figure>
                <img
                  src="	https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/10/3.jpg"
                  alt="Shoes"
                />
              </figure>
              <div className="card-body">
          ...
          <div className="mb-10 lg:mx-0 mx-4">
            <div className="card bg-base-100 shadow-xl border">
              <figure>
                <img
                  src="	https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/10/7.jpg"
                  alt="Shoes"
                />
              </figure>
              <div className="card-body">
          ...
          <div className="mb-10 lg:mx-0 mx-4">
            <div className="card bg-base-100 shadow-xl border">
              <figure>
                <img
                  src="https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/10/6.jpg"
                  alt="Shoes"
                />
              </figure>
              <div className="card-body">
          ...
          <div className="mb-10 lg:mx-0 mx-4">
            <div className="card bg-base-100 shadow-xl border">
              <figure>
                <img
                  src="https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/06/banner-bg9.jpg"
                  alt="Shoes"
                />
              </figure>
              <div className="card-body">
                ...
                <h2 className="card-title font-extrabold text-4xl my-4">
                  THE ENGLISH LEAGUE – MAN CITY CHAMPION AT PREMIER LEAGUE
                </h2>
                <p className="mb-4">
                  A great commerce experience cannot be distilled to a single
                  number. It’s not a Lighthouse score, or a set of Core Web
...
<button className="px-3 py-2 ml-4 mt-4 hover:text-white hover:bg-red-600 bg-gray-200 font-bold">SportsXplorer</button>
              </div>
            </div>
        </div>
      </div>
