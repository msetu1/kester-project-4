          ...
          <div className=" bg-base-100 shadow-xl border">
            <figure>
              <img
                ...
                src="	https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/10/7-1.jpg"
                alt="Shoes"
              />
            </figure>
        ...
        <div className="lg:mx-0 mx-3">
          <div className=" bg-base-100 shadow-xl border">
            <figure>
              <img
                className="bg-[#f6f6f6]  w-full p-5"
                src="	https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/10/6-1.jpg"
                alt="Shoes"
              />
            </figure>
            <div className="card-body ">
        ...
        <div className="lg:mx-0 mx-3">
          <div className=" bg-base-100 shadow-xl border">
            <figure>
              <img
                className="bg-[#f6f6f6]  w-full p-5"
                src="	https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/10/5.jpg"
                alt="Shoes"
              />
            </figure>
            <div className="card-body ">
        ...
        <div className="lg:mx-0 mx-3">
          <div className="bg-base-100 shadow-xl border">
            <figure>
              <img
                className="bg-[#f6f6f6]  w-full p-5"
                src="https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/10/4.jpg"
                alt="Shoes"
              />
            </figure>
            <div className="card-body ">
        ...
        <div className="lg:mx-0 mx-3">
          <div className=" bg-base-100 shadow-xl border">
            <figure>
              <img
                className="bg-[#f6f6f6]  w-full p-5"
                src="https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/10/3-1.jpg"
                alt="Shoes"
              />
            </figure>
            <div className="card-body ">
        ...
        <div className="lg:mx-0 mx-3">
          <div className=" bg-base-100 shadow-xl border">
            <figure>
              <img
                className="bg-[#f6f6f6]  w-full p-5"
                src="	https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/10/2.jpg"
                alt="Shoes"
              />
            </figure>
            <div className="card-body ">
        ...
        <div className="lg:mx-0 mx-3">
          <div className=" bg-base-100 shadow-xl border">
            <figure>
              <img
                className="bg-[#f6f6f6]  w-full p-5"
                src="https://themewant.com/products/wordpress/kester-cricket/wp-content/uploads/2023/10/8.jpg"
                alt="Shoes"
              />
            </figure>
            <div className="card-body ">
